 ...
 * @since		Version 1.1
 * @createdtime       2013-04-22 07:29:59
 */
...
class WoniuDB {
    ...
    public static function getInstance($config = null, $is_return = false) {
        global $woniu_db;
        $config = is_array($config) ? $config : $woniu_db[$woniu_db['active_group']];
        ...
        if ($is_return) {
            ...
            return isset(self::$conns['default']) ? self::$conns['default'] : self::$conns['default'] = new $class($config);
        }
    }
