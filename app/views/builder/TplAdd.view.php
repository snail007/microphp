                ...
                <table>
                    ...
                    foreach ($rows as $row) {
                        ...
                        <?php if ($row['type'] == 'text') { ?>
                            <tr><td><?php echo $row['name']; ?></td><td><input type="text" name="<?php echo $row['col']; ?>"/></td></tr>
                        <?php } elseif ($row['type'] == 'textarea') { ?>
                            <tr><td><?php echo $row['name']; ?></td><td><textarea style="width:400px;height:120px;" type="text" name="<?php echo $row['col']; ?>"></textarea></td></tr>
                        <?php } elseif ($row['type'] == 'textareahtml') { ?>
                            <tr><td><?php echo $row['name']; ?></td><td><textarea style="width:700px;height:350px;" class="textareahtml" type="text" id="<?php echo $row['col']; ?>" name="<?php echo $row['col']; ?>"></textarea></td></tr>
                        <?php } else { ?>
