...
<body><form method="post" action="?c=[{P('action_name')}]&m=Update" id="cform">
    <fieldset><legend><h3>修改界面</h3></legend>
       <hr class="hr1"/>
        <table>
        <!--<foreach($rows as $row){>-->
            <!--<if($row['type']=='text'){>-->
            <tr><td>[{$row['name']}]</td><td><input type="text" name="[{$row['col']}]" value="&{htmlspecialchars($row['[{$row['col']}]'])}&"/></td></tr>
            <!--<}elseif($row['type']=='textarea'){>-->
            <tr><td>[{$row['name']}]</td><td><textarea style="width:400px;height:120px;" type="text" name="[{$row['col']}]">&{htmlspecialchars($row['[{$row['col']}]'])}&</textarea></td></tr>
            <!--<}elseif($row['type']=='textareahtml'){>-->
            <tr><td>[{$row['name']}]</td><td><textarea style="width:700px;height:350px;" class="textareahtml" type="text" id="[{$row['col']}]" name="[{$row['col']}]">&{htmlspecialchars($row['[{$row['col']}]'])}&</textarea></td></tr>
             <!--<}elseif($row['type']=='hidden'){>-->
            <tr><td>&nbsp;</td><td><input type="hidden" name="[{$row['col']}]" value="&{htmlspecialchars($row['[{$row['col']}]'])}&"/></td></tr>
            <!--<}else{>-->
