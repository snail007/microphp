...
<body><form method="post" action="?Test.update" id="cform">
    <fieldset><legend><h3>修改界面</h3></legend>
       <hr class="hr1"/>
        <table>
                                <tr><td>&nbsp;</td><td><input type="hidden" name="id" value="<?php echo htmlspecialchars($row['id']);?>"/></td></tr>
                                            <tr><td>用户名</td><td><textarea style="width:700px;height:350px;" class="textareahtml" type="text" id="name" name="name"><?php echo htmlspecialchars($row['name']);?></textarea></td></tr>
