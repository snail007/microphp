...
";
	...
	public function setUp() {
		...
		$w->db->simple_query('DROP TABLE IF EXISTS for_validate_users');
		$w->db->simple_query('CREATE TABLE IF NOT EXISTS `for_validate_users` (
  `user_id` int(11) NOT NULL AUTO_INCREMENT,
  `uname` varchar(32) NOT NULL,
  `upass` varchar(32) NOT NULL,
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3');
		$w->db->simple_query("INSERT INTO `for_validate_users` (`user_id`, `uname`, `upass`) VALUES (1, 'admin', 'e3db72cddb1a34c9f3031ee0cd9ab521'),(2, 'admina', 'e3db72cddb1a34c9f3031ee0cd9ab521')");
	}
