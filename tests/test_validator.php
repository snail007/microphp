...
class Test_validator extends UnitTestCase {
    ...
    private $sql = "
DROP TABLE IF EXISTS for_validate_users;
CREATE TABLE IF NOT EXISTS `for_validate_users` (
...
--
-- 导出表中的数据 `for_validate_users`
--

INSERT INTO `for_validate_users` (`user_id`, `uname`, `upass`) VALUES
