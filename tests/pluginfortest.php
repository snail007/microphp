 ...
 */
$system['application_folder'] = dirname(__FILE__) . '/' . 'app';
/**
 * 存放控制器文件的文件夹路径名称
 */
...
$system['cache_config'] = array(
     ...
     * 留空，系统自己选择
     */
    "path" => dirname(__FILE__) . "/app/cache", // 缓存文件存储默认路径
